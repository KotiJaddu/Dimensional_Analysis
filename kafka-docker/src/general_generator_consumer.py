...
if __name__ == '__main__':
	general_generator_consumer = KafkaConsumer('general_generator', bootstrap_servers='localhost:55001', auto_offset_reset='earliest')
	for msg in general_generator_consumer:
		msg_string = msg.value.decode('utf-8')
		general_generator = General_Generator()
		split_msg = msg_string.split(',')
		f = open("general_generator.html", "w")
		f.write(general_generator.generate(int(split_msg[0]), int(split_msg[1])))
		f.close()
		webbrowser.open("C:\\Users\\kjaddu001\\Desktop\\kafka-docker\\src\\general_generator.html",new=2)
